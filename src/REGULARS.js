module.exports = [
    {
        ...
        examples: ['18118360369', '17801481989'],
    },
    {
        title: '手机号码(宽松)',
        rule: /^1[3-9]\d{9}$/,
    ...
    },
    {
        ...
        examples: ['025-83192650', '027-67867779'],
    },
    {
        title: '座机电话(包括港澳台)',
    ...
    },
    {
        ...
        examples: ['888888888.@qq.com', '23167127@163.com'],
    },
    {
        title: '身份证号',
        rule: /^\d{6}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
        examples: ['500222198105267734','42068418880424401x'],
    },
    {
        title: '护照(包含香港、澳门)',
    ...
    },
    {
        ...
        examples: ['wqjiao_3690', 'sadasda_33390'],
    },
    {
        title: '汉字',
        rule: /^[\u4E00-\u9FA5]+$/,
    ...
    },
    {
        title: '英文',
        rule: /^[a-zA-Z]+$/,
        examples: ['wqjiao','DDadsd'],
    },
    {
        title: '小写英文字母组成',
        rule: /^[a-z]+$/,
        examples: ['russel', 'dada']
    },
    {
        title: '大写英文字母组成',
        rule: /^[A-Z]+$/,
